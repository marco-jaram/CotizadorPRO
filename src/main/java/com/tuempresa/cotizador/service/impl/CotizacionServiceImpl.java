...
public class CotizacionServiceImpl implements CotizacionService {
    ...
    private String generarFolioUnico() {
        // Implementación simple para un folio único
    ...
    private CotizacionServiciosDTO mapToServiciosDTO(CotizacionServicios cotizacion) {
        ...
        dto.setTotal(lineasDTO.stream().map(LineaCotizacionServicioDTO::getSubtotal).reduce(BigDecimal.ZERO, BigDecimal::add));
        return dto;
    }
    ...
    private CotizacionProductosDTO mapToProductosDTO(CotizacionProductos cotizacion) {
        ...
        dto.setLineas(lineasDTO);
        dto.setTotal(lineasDTO.stream().map(LineaCotizacionProductoDTO::getSubtotal).reduce(BigDecimal.ZERO, BigDecimal::add));
        return dto;
    }
}